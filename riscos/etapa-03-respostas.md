Para os riscos mais relevantes, defina estratégias de resposta adequadas. Considere, evitar, mitigar, transferir ou aceitar o risco.

```text
Entregável esperado
+ estratégia proposta para cada risco;
...
1. Estratégias Possíveis por Risco - Para cada risco:
