Com base nos riscos identificados, realize uma análise qualitativa considerando possíveis impactos no projeto e fatores que podem influenciar sua ocorrência.

```text
Entregável esperado
+ análise estruturada dos riscos;
+ explicação dos impactos;
+ identificação de fatores condicionantes.
```
...
Saída: Apresente o resultado em formato estruturado, conforme o modelo abaixo:
